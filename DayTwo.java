// Day 2 of 100. Practiced File handling today
...
public class DayTwo {
    ...
    public static void main (String[] args) throws IOException
    {
        ...
        System.out.println("\n\n\n----------------------------------------------\n\n\n\n\n\n\n\n");
        for(int i = 0; i<10; i++) {
            System.out.println(Questions.get(i));               // Print Question
        ...
        String yourName = Take.next();

        System.out.println("\nTop Score is\n" + scoreCheck(score, yourName));
        Take.close();
    }
    ...
    public static String scoreUpdate (int Score, String name) throws IOException
    {
        ...
        BufferedWriter pen = new BufferedWriter(new FileWriter(path, false ));

        String ExistingTop = look.readLine();
        int TopScore = Integer.parseInt(ExistingTop.substring(0, 2)); 

        if (Score > TopScore)
        {
        ExistingTop = Score + " --> " + name;
        pen.write(String.format(%2d, Score) + " --> " + name);
        }
